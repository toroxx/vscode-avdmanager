...
export class SDKPlatformsTreeView {
    ...
    constructor(context: vscode.ExtensionContext, private manager: Manager) {
        ...
        subscribe(context, [
            ...
            vscode.commands.registerCommand('avdmanager.cmd-sdk-accept-license', () => {
                let sdkbin = this.manager.getConfig().sdkManager ?? "";
            ...
            vscode.commands.registerCommand('avdmanager.sdk-accept-license', () => {
                let sdkbin = this.manager.getConfig().sdkManager ?? "";
                let t = term("Accept SDK licenses", sdkbin + " --licenses");
    ...
    refresh = async () => this.manager.sdk.getSDKPlatforms(true).then(() => this.provider.refresh());
...
class SDKPlatformsTreeDataProvider implements vscode.TreeDataProvider<TreeItem> {
    ...
    getChildren(element?: TreeItem): Thenable<TreeItem[]> {
        ...
        return this.manager.sdk.getSDKPlatforms().then((items) => {
            let list: TreeItem[] = [];
